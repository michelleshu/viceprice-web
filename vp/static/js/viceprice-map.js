    ...
    marker.on('click', function(e) {
      ...
      if ($(window).width() < mediaScreenWidth) {
        ...
        $("#location-name").html(properties["name"]);
            ...
            $("#location-address").html("<a target="_blank" href='https://www.google.com/maps/dir/Current+Location/" + properties["latitude"] +"," + properties["longitude"]+"'>" + properties["street"] + "</a>");   
